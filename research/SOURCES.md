...
| `people/steve-yegge/beads/AGENT_INSTRUCTIONS.md` | [steveyegge/beads/AGENT_INSTRUCTIONS.md](https://github.com/steveyegge/beads/blob/main/AGENT_INSTRUCTIONS.md) | `main` | `a0c1f42e81f2b4430d4a93041d9f1adfcad3ff7f` |
| `people/simon-willison/llm/AGENTS.md` | [simonw/llm/AGENTS.md](https://github.com/simonw/llm/blob/main/AGENTS.md) | `main` | `bd645da55193f114b9e032e398d7730c92b1719a` |
| `people/matt-pocock/skills/CLAUDE.md` | [mattpocock/skills/CLAUDE.md](https://github.com/mattpocock/skills/blob/main/CLAUDE.md) | `main` | `2ab958093e83e0ec752e6c1c5932da465bf23e0c` |
| `people/affaan-hussein/everything-claude-code/AGENTS.md` | [affaan-m/everything-claude-code/AGENTS.md](https://github.com/affaan-m/everything-claude-code/blob/main/AGENTS.md) | `main` | `0c1d7be9a750627fb2a6534c78a998cc46d03f9c` |
| `people/affaan-hussein/everything-claude-code/CLAUDE.md` | [affaan-m/everything-claude-code/CLAUDE.md](https://github.com/affaan-m/everything-claude-code/blob/main/CLAUDE.md) | `main` | `0c1d7be9a750627fb2a6534c78a998cc46d03f9c` |
| `people/peter-steinberger/agent-scripts/AGENTS.MD` | [steipete/agent-scripts/AGENTS.MD](https://github.com/steipete/agent-scripts/blob/main/AGENTS.MD) | `main` | `c46ea65b6323e8a2b6f441f8b6449ae731bc8f81` |
| `people/peter-steinberger/deepsec/AGENTS.md` | [steipete/deepsec/AGENTS.md](https://github.com/steipete/deepsec/blob/main/AGENTS.md) | `main` | `ef0ffb1ea9a756240ea0128256af9be0a41e9faf` |
| `people/peter-steinberger/deepsec/CLAUDE.md` | [steipete/deepsec/CLAUDE.md](https://github.com/steipete/deepsec/blob/main/CLAUDE.md) | `main` | `ef0ffb1ea9a756240ea0128256af9be0a41e9faf` |
| `people/peter-steinberger/deepsec/.deepsec/AGENTS.md` | [steipete/deepsec/.deepsec/AGENTS.md](https://github.com/steipete/deepsec/blob/main/.deepsec/AGENTS.md) | `main` | `ef0ffb1ea9a756240ea0128256af9be0a41e9faf` |
| `people/peter-steinberger/claude-code-mcp/AGENT.md` | [steipete/claude-code-mcp/AGENT.md](https://github.com/steipete/claude-code-mcp/blob/main/AGENT.md) | `main` | `2e401f3ed81d32435ca6cfe85a3ac1404d318c84` |
| `people/peter-steinberger/claude-code-mcp/CLAUDE.md` | [steipete/claude-code-mcp/CLAUDE.md](https://github.com/steipete/claude-code-mcp/blob/main/CLAUDE.md) | `main` | `2e401f3ed81d32435ca6cfe85a3ac1404d318c84` |
| `people/harrison-chase/harbor/AGENTS.md` | [hwchase17/harbor/AGENTS.md](https://github.com/hwchase17/harbor/blob/main/AGENTS.md) | `main` | `1b1dbc43729edff705071a797bb0f98a90cf62f5` |
...
| Target file | Public source | Branch | Revision |
| --- | --- | --- | --- |
| `derived/andrej-karpathy/forrestchang/CLAUDE.md` | [forrestchang/andrej-karpathy-skills/CLAUDE.md](https://github.com/forrestchang/andrej-karpathy-skills/blob/main/CLAUDE.md) | `main` | `2c606141936f1eeef17fa3043a72095b4765b9c2` |

## Discovery sources

### X

- [Andrej Karpathy's coding workflow post](https://x.com/karpathy/status/2015883857489522876) directly discusses agent failure modes and attempts to address them with `CLAUDE.md` instructions.
- [Boris Cherny on encoding domain knowledge](https://x.com/bcherny/status/2077460395279692197) discusses `CLAUDE.md` rules, skills, docs, and automated checks.
- [Boris Cherny on AI adoption](https://x.com/bcherny/status/2077929379661844559) discusses verification and guardrails for teams using multiple agents.
- [Affaan Hussein's longform guide](https://x.com/affaan/status/2014040193557471352) points to his public agent harness work.
- [Alexandr Wang's public profile](https://x.com/alexandrwang) loaded, but it exposes one old post and no agent-rule file.

X search pages required login in the browser. Direct public profile and post pages loaded where listed above.

### Hacker News

The Hacker News Algolia API was queried for `CLAUDE.md`, `AGENTS.md`, `Karpathy CLAUDE.md`, `Boris Cherny CLAUDE.md`, and related terms.

- [Writing a good Claude.md](https://news.ycombinator.com/item?id=46098838) was a high-signal discussion page.
...
- [Devpost software search for `CLAUDE.md`](https://devpost.com/software?query=CLAUDE.md)
- [Devpost software search for `AGENTS.md`](https://devpost.com/software?query=AGENTS.md)

The pages loaded, but they did not expose a verifiable agent-rule file tied to one of the named people. No Devpost file was added.
...
- [Affaan Hussein](https://github.com/affaan-m)
